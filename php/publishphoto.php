...
mysql_select_db($database_localhost, $localhost);
$query_update = sprintf("insert into userphoto (userid, urn, creationdate,post_type,filename) values (%s,%s,NOW(),%s,%s)", $row_user['id'], GetSQLValueString($_POST['urn'], "text"), GetSQLValueString($_POST['facebook_optin'], "text"),GetSQLValueString($_POST['file'], "text"));
$update = mysql_query($query_update, $localhost) or die("result=ERROR&message=".urlencode(mysql_error())."&SQL=".$query_update);
